...
-- A Special Surprise
UPDATE creature_template SET ScriptName='npc_a_special_surprise',unit_flags=2 WHERE entry IN (29032,29061,29065,29067,29068,29070,29074,29072,29073,29071);
...
UPDATE creature_template SET ScriptName='mob_eventai', AIName='EventAI',unit_flags=0,type_flags=8 WHERE entry IN (29199,29204,29200,29174,29182,29186,29190,29219,29206,29176,29178,29179,29180,29177,29181);
